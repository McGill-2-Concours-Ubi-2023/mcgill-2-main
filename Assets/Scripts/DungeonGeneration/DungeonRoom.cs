...
public class DungeonRoom : MonoBehaviour
{
    ...
    public static void PopulateRooms(List<DungeonRoom> rooms)
    {
        if (allRooms == null)
        {
            allRooms = rooms;
    ...
    public void SetDoorsParent(GameObject parent)
    {
        doors.ForEach(door => door.transform.parent = parent.transform);
    }
